<template>
    <div class="ui container">
        ...
        <p>Popup component, did you noted that semantic-ui has a Popup module that you can use without javascript? But, if you need something more "complex", This is something helpful.</p>
        <p>
